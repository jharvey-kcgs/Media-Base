...
6. **Vinyl/CD** - data layer done (title search/barcode via Discogs, a real direct match unlike the UPC-fuzzy-match family this was originally grouped with), screens/VinylScreen.tsx itself still pending → Tabletop Games next
